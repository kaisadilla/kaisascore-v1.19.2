...
public class ToolWorkbenchRecipe implements Recipe<Container> {
    public static final String RECIPE_NAME = "tool_workbench";

    public static final int MATRIX_SIZE = ToolWorkbenchMenu.MATRIX_SIZE;
    ...
    public static class Serializer implements RecipeSerializer<ToolWorkbenchRecipe> {
        ...
        @Override
        public ToolWorkbenchRecipe fromJson (
            ...
            return new ToolWorkbenchRecipe(
                recipeId, width, height, ingredients, result
            );
        }

        @Override
        public @Nullable ToolWorkbenchRecipe fromNetwork (
        ...
        public void toNetwork (
            FriendlyByteBuf buffer, ToolWorkbenchRecipe recipe
        ) {
