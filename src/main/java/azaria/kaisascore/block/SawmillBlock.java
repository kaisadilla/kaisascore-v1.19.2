...
public class SawmillBlock extends BaseEntityBlock {
    protected SawmillBlock (Properties props) {
        super(props);
    }
    ...
    public InteractionResult use (
        ...
        if (level.isClientSide() == false) {
            ...
            if (ent instanceof SawmillBlockEntity sawmillBE) {
                NetworkHooks.openScreen((ServerPlayer)player, sawmillBE, pos);
            }
            else {
